# 본 이야기는 대부분 허구이며, 실제 사건을 각색하거나 완전한 허구를 차용하였습니다.
...
사투리와 배경 때문에 “쟤는 뭐가 좀 다르다”는 말 종종 들음
...
매일 조업 루트 GPS 기록 → “우린 원래 여기서 일하던 사람입니다”
...
그걸 지키기 위해, 작고 튼튼한 R0를 손에 쥐었지.”
 ...
 캐릭터 – 론웨 므보 (Lwandle Mbo), 17세 / 남아프리카공화국 / 고등학생
• 배경:
론웨는 요하네스버그 외곽의 빈곤지역에서 자라났다.
학교까지의 거리는 먼데, 통학 중 괴롭힘은 일상이었다.
남학생 몇 명은 그녀의 교복을 찍으며 조롱했고, “여자라면 조용히 있으라”는 교사도 있었다.

어느 날, 그녀는 학교 복도에서 선생님의 성희롱성 발언을 듣고 말았다.
하지만 주변은 조용했다.
“괜히 입 열었다가 퇴학 당하면?”
“어차피 아무도 안 믿을걸?”

그러나 론웨에겐 단 하나의 동반자가 있었다.

• Aegis R0 Rights 활용:
녹음 + 스텔스 촬영 기능: 화면 꺼진 상태에서 자동 녹음. 선생님의 언행을 생생히 기록.

PTT 버튼 기능: 급박한 상황에서 즉시 NGO 보호 핫라인으로 메시지 전송.

서면 진술 모드: 녹음된 내용을 기반으로 자동 정리된 진술서를 생성해 법률 지원 NGO에 전송.

오프라인 전송 큐잉: 인터넷이 없을 땐 저장, 연결 시 자동 전송.

• 결과:
현지 여성 권리 NGO가 사건에 개입해 조사를 시작.
다른 피해 학생들도 용기를 얻어 증언에 참여.
가해 교사는 직위 해제, 학교는 성교육과 성폭력 예방 훈련을 의무화.

론웨는 이제 NGO 홍보대사로 활동하며 이렇게 말한다:

“우리는 ‘희생자’가 아니라,
증거를 들고 일어선 ‘생존자’예요.
Aegis R0는 나를 도와준 첫 번째 어른이었어요.”
